...
<8> Set the column auto-width mode for the `ID` property
<9> Set the auto-width mode for all the listing columns
<10> Add a listener for listing columns resize events
<11> Add a listener for listing columns reordering events
