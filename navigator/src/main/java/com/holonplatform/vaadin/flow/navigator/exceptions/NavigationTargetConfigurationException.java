...
public class NavigationTargetConfigurationException extends RuntimeException {
	 ...
	 */
	public NavigationTargetConfigurationException(String message) {
		super(message);
	}
	 ...
	 */
	public NavigationTargetConfigurationException(Throwable cause) {
		super(cause);
	}
	 ...
	 * @param cause Nested exception
	 */
	public NavigationTargetConfigurationException(String message, Throwable cause) {
		super(message, cause);
	}
