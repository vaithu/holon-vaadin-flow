...
import settings from './target/vaadin-dev-server-settings.json' with { type: 'json' };
import {
  AssetInfo,
  ChunkInfo,
  defineConfig,
...
export { default as useLocalWebComponents } from './target/plugins/vite-plugin-local-web-components/index.ts';
