...
public class IndexView extends Div {
    ...
    public IndexView() {
        ...
        List<Entry> entries = List.of(
                ...
                new Entry("MaterialHeader",
                        "Material 3 content header with breadcrumb, media, headline, subtitle, details, tags, and primary/secondary action slots. Small/medium/large variants with ViewMode-driven action collapsing.",
                        MaterialHeaderDemoView.class),
                new Entry("MaterialAppBar",
                        "Material 3 app bar with explicit leading, headline, subtitle, and trailing action slots. Small, search, medium-flexible, and large-flexible variants with alignment and scroll-state configuration.",
                        MaterialAppBarDemoView.class),
                new Entry("Highlight",
                ...
                new Entry("ItemLineEditor",
                        "Generic, domain-agnostic editable line-item list engine — reused unmodified across invoice lines, shopping-cart lines, and pawn-ticket item appraisal, with live footer totals.",
                        ItemLineEditorDemoView.class),
                new Entry("InputOTP",
