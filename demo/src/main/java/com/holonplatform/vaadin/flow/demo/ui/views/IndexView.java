...
public class IndexView extends Div {
    ...
    public IndexView() {
        ...
        List<Entry> entries = List.of(
                ...
                new Entry("MasterDetailLayout",
                        "Signal-driven master-detail layout: mobile sheet overlay, tablet/desktop side-by-side, lazy DOM, URL ?id= sync, and auto-refresh on data change.",
                        MasterDetailLayoutDemoView.class),
