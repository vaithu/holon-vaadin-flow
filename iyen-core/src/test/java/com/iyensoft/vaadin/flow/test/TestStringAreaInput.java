...
//		assertTrue(input.getComponent() instanceof HasPrefixAndSuffix);
	...
	public void testTextInput() {
		...
		Input<String> input = Input.stringArea().valueChangeMode(ValueChangeMode.ON_CHANGE).build();
	...
	public void testAdapters() {
		...
		Input<String> input = Input.stringArea().withAdapter(TestAdapter.class, i -> TestAdapter.create(i, 789))
				.build();
