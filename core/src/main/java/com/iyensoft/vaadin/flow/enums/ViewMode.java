...
public enum ViewMode {
    ...
    /**
     * Returns {@code true} if this mode represents a mobile viewport
     * (phone portrait, phone landscape, or generic mobile).
     */
    public boolean isMobile() {
        return this == MOBILE || this == MOBILE_PORTRAIT || this == MOBILE_LANDSCAPE;
    }
