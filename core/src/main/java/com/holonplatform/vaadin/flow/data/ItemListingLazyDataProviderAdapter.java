...
public interface ItemListingLazyDataProviderAdapter<T, F> extends BackEndDataProvider<T, F> {
	...
	/**
	 * Create a new {@link ItemListingLazyDataProviderAdapter} using given concrete <code>dataProvider</code>.
	 * @param <T> Data type
	 * @param <F> Filter type
	 * @param dataProvider The concrete data provider (not null)
	 * @return A new {@link ItemListingLazyDataProviderAdapter}
	 */
	static <T, F> ItemListingLazyDataProviderAdapter<T, F> adapt(BackEndDataProvider<T, F> dataProvider) {
		return new DefaultItemListingLazyDataProviderAdapter<>(dataProvider);
