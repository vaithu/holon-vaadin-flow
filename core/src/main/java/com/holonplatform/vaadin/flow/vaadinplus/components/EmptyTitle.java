...
/**
 * Title slot of an {@link Empty} component.
 *
...
public class EmptyTitle extends Div {
     ...
     */
    public EmptyTitle(String text) {
        addClassName("empty__title");
        setText(text);
    }
     ...
     */
    public EmptyTitle(Localizable localizable) {
        addClassName("empty__title");
     ...
     */
    public EmptyTitle(Component... components) {
        addClassName("empty__title");
        add(components);
    }
