...
public interface ItemListing<T, P> extends ItemSet, Selectable<T>, HasComponent {
    ...
    void setFrozenMultiSelectCheckBoxColumn(boolean frozen);

    void setFrozenToEnd(P property, boolean frozen);

    void setScrollUsingUpDownKeys();

    void setToggleableColumns();
    ...
    void removeThemeVariants(GridVariant... variants);
...
/*	GridLazyDataView<T> getLazyDataView();
	...
	GridLazyDataView<T> setItems(BackEndDataProvider<T, Void> backEndDataProvider);*/
    ...
    public interface ItemListingCell {
        ...
        default void cellColor(String cellColor) {
            setPartName(cellColor);
        }
