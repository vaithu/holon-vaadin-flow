...
public interface DialogConfigurator<C extends DialogConfigurator<C>> extends ComponentConfigurator<C>,
    ...
    C withHeader(String title, Component component);
    ...
    C withFooter(boolean showCancelBtn, Consumer<ButtonConfigurator.BaseButtonConfigurator> deleteConfigurator);

    C withFooter(Consumer<ButtonConfigurator.BaseButtonConfigurator> configurator);

    C withFooter(String btnText, ClickEventListener<Button, ClickEvent<Button>> buttonClickEvent);
    C withFooter(String btnText, String btnTextCode, ClickEventListener<Button, ClickEvent<Button>> buttonClickEvent);

    default C withDeleteFooter(String delBtnText,ClickEventListener<Button, ClickEvent<Button>> buttonClickEvent) {
        return withFooter(delBtnText, buttonClickEvent);
    }

    default C withSaveFooter(String saveBtnText,ClickEventListener<Button, ClickEvent<Button>> buttonClickEvent) {
        return withFooter(saveBtnText, buttonClickEvent);
    }

    default C withSaveFooter(Consumer<ButtonConfigurator.BaseButtonConfigurator> saveConfigurator) {
        return withFooter(true,saveConfigurator);
    }

    default C withDeleteFooter(Consumer<ButtonConfigurator.BaseButtonConfigurator> deleteConfigurator) {
        return withFooter(true,deleteConfigurator);
    }

    default C withCancelFooter(Component... components) {
        return withFooter(true, components);
    }

    C withFooter(boolean showCancelBtn, Component... components);

    C withFooter(Consumer<ButtonConfigurator.BaseButtonConfigurator> cancelConfigurator, Component... components);
