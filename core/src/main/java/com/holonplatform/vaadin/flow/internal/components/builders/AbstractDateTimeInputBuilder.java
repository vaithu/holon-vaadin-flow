...
public abstract class AbstractDateTimeInputBuilder<C extends DateTimeInputConfigurator<C>>
	...
	public C elementConfiguration(Consumer<Element> element) {
		localDateTimeInputBuilder.elementConfiguration(element);
		return getConfigurator();
	}
	...
	public ShortcutConfigurator<C> withFocusShortcut(Key key) {
		return new DefaultShortcutConfigurator<>(localDateTimeInputBuilder.getComponent().addFocusShortcut(key),
				getConfigurator());
	}
