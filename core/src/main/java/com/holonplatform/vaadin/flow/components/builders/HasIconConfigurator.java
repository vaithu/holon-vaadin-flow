...
public interface HasIconConfigurator<C extends HasIconConfigurator<C>> {
	...
	/**
	 * Obtain an {@link IconConfigurator} for given {@link VaadinIcon} representation to create the icon and content it
	 * to che component using {@link IconConfigurator#add()}.
	 * @param icon The icon to create and content to the component (not null)
	...
	/**
	 * Obtain an {@link IconConfigurator} for given icon to create it and content it to che component using
	...
	/**
	 * Obtain an {@link IconConfigurator} for given {@link Icon} representation to create the icon and content it to
