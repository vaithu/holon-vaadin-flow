...
public class TotalsLabel extends Span {
    ...
    /**
     * Creates a label with a plain text string.
     *
     * @param text the label text
     */
    public TotalsLabel(String text) {
        addClassName("totals-card__label");
        setText(text);
    }

    /**
     * Creates a label backed by a {@link Localizable} message.
     * The text is resolved using the current locale; re-resolved on each attach.
     *
     * @param localizable the localizable message
     */
    public TotalsLabel(Localizable localizable) {
        addClassName("totals-card__label");
        setLocalizableText(localizable);
    }

    /**
     * Creates a label containing arbitrary child components.
     *
     * @param components child components
     */
    public TotalsLabel(Component... components) {
        addClassName("totals-card__label");
        add(components);
    }
    ...
    /**
     * Updates the label text from a {@link Localizable} message.
