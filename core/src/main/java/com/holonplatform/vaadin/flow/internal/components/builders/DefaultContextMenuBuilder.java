...
public class DefaultContextMenuBuilder
	...
	public DefaultContextMenuBuilder() {
		super(new ContextMenu(),
				(menu, text) -> menu.addItem(text, (com.vaadin.flow.component.ComponentEventListener<com.vaadin.flow.component.ClickEvent<MenuItem>>) null),
				(menu, component) -> menu.addItem(component, (com.vaadin.flow.component.ComponentEventListener<com.vaadin.flow.component.ClickEvent<MenuItem>>) null),
				e -> ComponentClickListenerAdapter.configure(new DefaultClickEvent<>(e.getSource(), e.isFromClient()), e));
	}
