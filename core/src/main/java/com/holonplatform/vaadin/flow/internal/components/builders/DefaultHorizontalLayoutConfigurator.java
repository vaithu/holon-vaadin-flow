...
/**
 * Default {@link HorizontalLayoutConfigurator} implementation.
 *
 * @since 5.2.0
 */
public class DefaultHorizontalLayoutConfigurator
		extends AbstractThemableFlexComponentConfigurator<HorizontalLayout, HorizontalLayoutConfigurator>
		implements HorizontalLayoutConfigurator {
	 ...
	 */
	@Override
	protected HorizontalLayoutConfigurator getConfigurator() {
		return this;
	}
