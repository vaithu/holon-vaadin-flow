 ...
 * <p>Renders as:</p>
 * <pre>
 * &lt;div class="carousel__next [carousel__button--disabled]"
 *      aria-label="Next slide" role="button" tabindex="0"&gt;
 *   &lt;vaadin-icon class="carousel__button-icon" icon="vaadin:chevron-right"&gt;&lt;/vaadin-icon&gt;
 * &lt;/div&gt;
 * </pre>
 *
 * @see Carousel
 ...
 */
public class CarouselNext extends Div implements ClickNotifier<Div> {
    ...
    /**
     * Creates the next-slide button with a chevron-right icon.
     */
    public CarouselNext() {
