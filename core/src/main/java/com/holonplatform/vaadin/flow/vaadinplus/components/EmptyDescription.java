...
public class EmptyDescription extends Div  {
     ...
     */
    public EmptyDescription(String text) {
        addClassName("empty__description");
        setText(text);
    }
     ...
     */
    public EmptyDescription(Localizable localizable) {
        addClassName("empty__description");
     ...
     */
    public EmptyDescription(Component... components) {
        addClassName("empty__description");
        add(components);
    }
