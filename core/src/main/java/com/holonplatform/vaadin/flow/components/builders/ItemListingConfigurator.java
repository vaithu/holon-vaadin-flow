...
public interface ItemListingConfigurator<T, P, L extends ItemListing<T, P>, C extends ItemListingConfigurator<T, P, L, C>>
        ...
        HasLazyDataViewConfigurator<T, Void, C>,
     ...
     */
    C headerPartName(P property, String headerPartName);
     ...
     *
     * @param property,      the part name to set
     * @param footerPartName the part name to set
     */
    C footerPartName(P property, String footerPartName);
