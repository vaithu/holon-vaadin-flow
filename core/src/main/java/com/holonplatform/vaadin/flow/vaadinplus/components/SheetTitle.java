...
/**
 * Title slot of a {@link Sheet} component.
 *
 ...
 * @see Sheet
 */
public class SheetTitle extends Div implements HasSize, HasStyle {
     ...
     */
    public SheetTitle(String text) {
        addClassName("sheet__title");
        setText(text);
    }
     ...
     */
    public SheetTitle(Localizable localizable) {
        addClassName("sheet__title");
     ...
     */
    public SheetTitle(Component... components) {
        addClassName("sheet__title");
        add(components);
    }
