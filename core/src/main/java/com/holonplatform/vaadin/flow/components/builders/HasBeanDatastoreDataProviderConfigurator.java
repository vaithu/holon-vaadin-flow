 ...
 * @since 5.2.0
 */
public interface HasBeanDatastoreDataProviderConfigurator<T, D extends DatastoreDataProviderConfigurator<T, D>,
		C extends HasBeanDatastoreDataProviderConfigurator<T, D, C>>
