...
public interface FlexComponentConfigurator<C extends FlexComponentConfigurator<C>>
	...
	/**
	 * Apply an inline configuration block to this layout configurator.
	 * This is an escape hatch for one-off tweaks that are not covered by the fluent API.
	 * The consumer receives {@code this} configurator and can call any of its methods.
	 * <p>Renamed from {@code withPostProcessor} (which clashed with
	 * {@link com.holonplatform.vaadin.flow.components.builders.ComponentBuilder#withPostProcessor}).</p>
	 * @param configurator Consumer to apply (not null)
	 * @return this
	 * @since 10.0.3
	 */
	C configure(Consumer<FlexComponentConfigurator<C>> configurator);
